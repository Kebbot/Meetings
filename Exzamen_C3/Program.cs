/*Meetings g = new Meetings();
g.Print();

public class Meetings
{
    private List<string> meetings;
    private List<object> dateNow;
    //private object dateNow;
    public Meetings()
    {
        this.meetings = new List<string> { };
        this.dateNow = new List<object> { };
    }
    public void Print()
    {
        foreach (var i in this.dateNow)
        {
            Console.WriteLine(i);
        }
    }
    ...
    private int Menu()
    {
        ...
        Console.WriteLine("4 - Проверить свои встречи");
    ...
    {
        string? AddMeetings;
        Console.WriteLine("Введите встречу:");
        AddMeetings = Console.ReadLine();
        this.meetings.Add(AddMeetings);
    }
}
